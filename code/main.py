...
from core.handlers.survey_handlers import handler_of_start_survey, handler_of_authenticated_with_no_choice_answer
...
async def start():
    ...
    dp.message.register(handler_of_start_survey, SurveyState.WAITING)
